...
String create_package() {
  ...
  return ("#" +String(int(litre_hr)) +delimiter +String(int(litre_hrFiltered)) + delimiter + String(int(flow_conversion_exponent(litre_hrFiltered))) + delimiter + String(int(potFiltered)));
